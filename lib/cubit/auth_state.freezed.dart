...
mixin _$AuthState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, value, name, age, user);

  @override
  String toString() {
    return 'AuthState(value: $value, name: $name, age: $age, user: $user)';
  }
}
...
abstract mixin class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String value, String name, int age, User? user});
...
class _AuthState implements AuthState {
  _AuthState({this.value = '', this.name = '', this.age = 1, this.user});
